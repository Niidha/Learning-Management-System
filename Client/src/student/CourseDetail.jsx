...
const CourseDetail = () => {
  ...
  return (
    <div>
      ...
      />
      <div className="coursedetail-box-can">
        <div className="coursedetail-box">
          {role === 'provider' && (
            <button onClick={() => navigate(`/edit-course/${id}`)} className="edit-btn mt-5 "><FaPen /></button>
          )}
          {/* <div className="coursedetail-image-container">
            <img src={course.image} alt={course.title} className="course-image d-flex justify-content" />
          </div> */}
          <h1 className="coursedetail-title mt-5">{course.title}</h1>
